...
$latest_query = "SELECT temperature, humidity, sound_value FROM sarang2 ORDER BY timestamp DESC LIMIT 1";
$latest_result = $conn->query($latest_query);
$latest_data = $latest_result->fetch_assoc();

// Fetch historical data for the chart
$history_query = "SELECT timestamp, sound_value FROM sarang2 ORDER BY timestamp DESC LIMIT 20";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO sarang2 (temperature, humidity, sound_value) VALUES (?, ?, ?)");
...
$table_query = "SELECT * FROM sarang2 ORDER BY timestamp DESC";
...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="sarang2.php"><i class="fas fa-beehive"></i> Sarang 1</a>
